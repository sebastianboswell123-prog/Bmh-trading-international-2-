    ...
    <footer style={{ background: 'var(--bg-alt)' }}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[15px] leading-relaxed mb-6 font-light" style={{ color: 'var(--text-muted)' }}>
          ...
          <div>
            <h4
              className="text-[12px] font-medium tracking-[0.35em] uppercase mb-6"
            ...
            <ul className="space-y-3">
              {['Plant', 'Parts'].map((item) => (
                <li key={item}>
                  <Link
                    to={`/${item.toLowerCase()}`}
                    className="text-[15px] font-light flex items-center gap-1.5 transition-colors duration-300"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[15px] leading-relaxed font-light" style={{ color: 'var(--text-muted)' }}>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="https://wa.me/27827800084" target="_blank" rel="noopener noreferrer" className="text-[15px] font-light" style={{ color: 'var(--text-muted)' }}>
                  WhatsApp Us
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={14} strokeWidth={1.5} className="shrink-0" style={{ color: 'var(--text-dim)' }} />
                <a href="mailto:bradleyh@bmhtradinginternational.com" className="text-[15px] font-light break-all" style={{ color: 'var(--text-muted)' }}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex gap-8">
          ...
          <span className="text-[13px] font-light cursor-pointer transition-colors duration-300 hover:text-[var(--text-muted)]" style={{ color: 'var(--text-dim)' }}>Terms of Service</span>
        </div>
      </div>
    </footer>
  );
